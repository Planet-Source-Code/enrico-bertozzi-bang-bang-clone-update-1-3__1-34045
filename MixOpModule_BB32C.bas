...
Public Const drVertical As Byte = 1, drHorizontal As Byte = 0
Public FStep(21) As Long, StepC As Byte
Public R(21) As Long, G(21) As Long, B(21) As Long
Public Declare Sub Sleep Lib "kernel32" (ByVal dwMilliseconds As Long)

Public Sub ObjFade(OB As Object, ByVal Direction As Byte, Optional BackColorR As Byte, Optional BackColorG As Byte, Optional BackColorB As Byte)  'RGB tones and FadeSteps are located in their respective variables
...
If StepC = 0 Then
 ...
 Exit Sub
End If
 If Direction = drVertical Then FStep(StepC) = OB.ScaleHeight Else FStep(StepC) = OB.ScaleWidth
 R(StepC) = BackColorR
 G(StepC) = BackColorG
 B(StepC) = BackColorB
 R(0) = BackColorR
